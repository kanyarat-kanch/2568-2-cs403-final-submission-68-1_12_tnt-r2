...
2.1. **ไฟล์เล่มรายงานฉบับสมบูรณ์** : ไฟล์เล่มรายงานฉบับสมบูรณ์ (pdf) ซึ่งคณะกรรมการสอบทุกท่านลงนามเรียบร้อยแล้วทุกหน้า ตั้งชื่อไฟล์ว่า `68-1_CS403_<รหัสโครงงาน>.pdf` เช่น โครงงานวิชาคพ.403 รหัสโครงงาน **67-1_01_ssr-s2** ให้ตั้งชื่อไฟล์เล่มรายงาน ดังนี้ `68-1_CS403_67-1_01_ssr-s2.pdf` 

<ins>หมายเหตุ</ins> i ในหน้าสำหรับคณะกรรมการลงลายมือชื่อ (หน้า (3) และ (4)) ให้ลงวันที่ 19 ธันวาคม พ.ศ. 2568 
...
2.2. **ไฟล์บทคัดย่อโครงงาน (ภาษาไทย)** : ไฟล์บทคัดย่อโครงงาน (ภาษาไทย) ซึ่งภายในไฟล์มีชื่อโครงงานภาษาไทยอยู่ที่บรรทัดแรก ชื่อโครงงานภาษาอังกฤษอยู่ที่บรรทัดที่สอง ตามด้วยบทคัดย่อโครงงาน (ภาษาไทย) โดยตั้งชื่อไฟล์ว่า `68-1_CS403_<รหัสโครงงาน>_abstract_th.txt` เช่น โครงงานวิชาคพ.403 รหัสโครงงาน **67-1_01_ssr-s2** ตั้งชื่อไฟล์บทคัดย่อโครงงาน (ภาษาไทย) ดังนี้ `68-1_CS403_67-1_01_ssr-s2_abstract_th.txt`

2.3. **ไฟล์บทคัดย่อโครงงาน (ภาษาอังกฤษ)** : ไฟล์บทคัดย่อโครงงาน (ภาษาอังกฤษ) ซึ่งภายในไฟล์มีชื่อโครงงานภาษาไทยอยู่ที่บรรทัดแรก ชื่อโครงงานภาษาอังกฤษอยู่ที่บรรทัดที่สอง ตามด้วยบทคัดย่อโครงงาน (ภาษาอังกฤษ) โดยตั้งชื่อไฟล์ว่า `68-1_CS403_<รหัสโครงงาน>_abstract_en.txt` เช่น โครงงานวิชาคพ.403 รหัสโครงงาน **67-1_01_ssr-s2** ตั้งชื่อไฟล์บทคัดย่อโครงงาน (ภาษาอังกฤษ) ดังนี้ `68-1_CS403_67-1_01_ssr-s2_abstract_en.txt`

**3.โฟลเดอร์ demo/** : มีลิงก์ไปยังไฟล์วีดีโอคลิปแสดงขั้นตอนการติดตั้งโปรแกรมผลงานของนักศึกษาเพื่อใช้งาน โดยให้ตั้งชื่อไฟล์วีดีโอคลิปเป็น 
`68-1_CS403_<รหัสโครงงาน>_demo.mp4` และวาง URL ของไฟล์วีดีโอคลิปนี้ใน text file ตั้งชื่อไฟล์เป็น `68-1_CS403_<รหัสโครงงาน>_demo_link.txt` 
เช่น โครงงานวิชาคพ.403 รหัสโครงงาน **67-1_01_ssr-s2** 
ตั้งชื่อไฟล์วีดีโอคลิปและไฟล์ซึ่งเก็บลิงก์ไปที่วีดีโอคลิป ดังนี้ `68-1_CS403_67-1_01_ssr-s2_demo.mp4` และ `68-1_CS403_67-1_01_ssr-s2_demo_link.txt` 
 
อย่าลืม ต้องตั้งค่าการเข้าถึงไฟล์วีดีโอคลิปเป็น Public / Anyone can view
...
<img width="1824" height="578" alt="image" src="https://github.com/user-attachments/assets/89d86a2b-c87d-43c9-a1c7-868579d01b26" />
